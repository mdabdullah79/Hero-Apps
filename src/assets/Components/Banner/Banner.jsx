  ...
  return (
    <div className="flex flex-col justify-center items-center mt-7">
      ...
      <div className=" bg-gradient-to-r from-[#632EE3] to-[#9F62F2] w-full p-10 h-[350px]">
        <h1 className="text-3xl md:text-[48px] text-center text-white font-bold mb-8">
          Trusted by Millions, Built for You
        </h1>

        <div className="flex items-center justify-center gap-3">
          <div className="flex flex-col items-center justify-center">
            <p className="text-[10px] md:text-[16px] text-white font-light">Total Downloads</p>
            <h2 className="text-3xl md:text-6xl font-extrabold text-white m-3">29.6M</h2>
          ...
          <div className="flex flex-col items-center justify-center">
            <p className="text-[8px] md:text-[16px] text-white font-light">Total Reviews</p>
            <h2 className="text-3xl md:text-6xl font-extrabold text-white m-3">906K</h2>
            <p className="text-[8px] md:text-[16px] text-white font-light mb-2.5">
              21% more than last month
            </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center">
            <p className="text-[8px] md:text-[16px] text-white font-light">Total Downloads</p>
            <h2 className="text-3xl md:text-6xl font-extrabold text-white m-3">29.6M</h2>
            <p className="text-[8px] md:text-[16px] text-white font-light mb-2.5">
              21% more than last month
            </p>
